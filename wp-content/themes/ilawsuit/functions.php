...
function load_my_styles_scripts()
{
    ...
    if (get_query_var('currentstate') && get_query_var('currentcity')) {
        ...
        $google_map_api = 'AIzaSyChzxFAVcjAp_u54o_pMNaKQhkBnfJsbzc';
...
// overrides the confirmation on form 2 to just redirect back itself (the ?p=post_id doesnt redirect properly when
//starting on the bio post, but works from settings from antoher page like "create a profile"
